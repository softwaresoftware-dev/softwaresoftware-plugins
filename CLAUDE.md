...
This is the `softwaresoftware-plugins` marketplace registry (`softwaresoftware-dev/softwaresoftware-plugins`). Not a plugin itself — it lists all published plugins for discovery.
